...
class Database():
    ...
    def setUpTestDb(self,y):
        ...
        self.writeQuery("""insert into users (username, password) values ('test1','{}')""".format(y[0]))
        self.writeQuery("""insert into users (username, password) values ('test2','{}')""".format(y[1]))
