...
class Database():
    ...
    def setUpTestDb(self,y):
        ...
        print(self.writeQuery("create table users (username text, password text, games text, friends text, friend_requests text)"))
        print(self.writeQuery("create table games (game_id text, game_data json, players text, turn text)"))
        print(self.writeQuery("""insert into users (username, password) values ('test1','{}')""".format(encryptString(y[0]))))
        print(self.writeQuery("""insert into users (username, password) values ('test2','{}')""".format(encryptString(y[1]))))
